...
// genopts --outfile=bookmarkletgen/options.go 'outfileHTML:string' 'outfileMD:string' 'baseSourceURL:string' 'footerHTML:string' 'footerHTMLFile:string' 'headerHTML:string' 'headerHTMLFile:string' 'templateHTML:string' 'templateHTMLFile:string'
